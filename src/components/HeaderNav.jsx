...
const HeaderNav = () => {
  ...
  return (
    <nav className={style.navBar}>
      <p className={style.navLink} onMouseEnter={(e) => about(e)}>about</p>
      ...
      <p className={style.navLink} onMouseEnter={(e) => about(e)}>locations</p>
      ...
      <p className={style.navLink} onMouseEnter={(e) => about(e)}>press</p>
      ...
      <p className={style.navLink} onMouseEnter={(e) => about(e)}>join us</p>
      ...
      <p className={style.navLink} onMouseEnter={(e) => about(e)}>investors</p>
