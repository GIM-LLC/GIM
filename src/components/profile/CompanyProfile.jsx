    ...
    <section className={style.companyProfile}>
      <article className={style.story}>
        ...
        <article>
          ...
          <p>
            ...
            earned a reputation from our customers as a source supplier of high
            quality, low cost precision parts with on-time deliveries. We are a
            top quality team of employees who work well together.
          </p>
        </article>
      </article>
      ...
      <section className={style.news}>
        ...
        <article>
          ...
          <p>
            With the unexpected passing of one of our long time employees, HR
            has organized a fundraiser to help the family of our late team
            member.
          </p>
        </article>
      </section>
